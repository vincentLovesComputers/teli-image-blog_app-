...
public class AutomobileFragment extends Fragment implements Redirect {
    ...
    AutomobileFragment(Activity activity){
    ...
    private void getBlogData() {
        if(recyclerView !=null){
            recyclerView.addOnScrollListener(
                    new RecyclerView.OnScrollListener() {
                        ...
                        public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                            ...
                            if(bottomReached){
                                service.loadMorePosts("Automobile", getActivity(), new GetBlogCallback() {
                                    @Override
            ...
            service.loadFirstPosts("Automobile", getActivity(), new GetBlogCallback() {
                @Override
                public void onCallBack(BlogPost blogPost) {
                    if(blogPost !=null){
                        blogPostList.add(blogPost);
    ...
    public void initViews(View mView){
        ...
        recyclerView = mView.findViewById(R.id.automobile_recycler);
