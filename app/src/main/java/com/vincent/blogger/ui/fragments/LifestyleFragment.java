...
public class LifestyleFragment extends Fragment implements Redirect {
    ...
    LifestyleFragment(Activity activity){
    ...
    private void getBlogData() {
        if(recyclerView !=null){
            recyclerView.addOnScrollListener(
                    new RecyclerView.OnScrollListener() {
                        ...
                        public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                            ...
                            if(bottomReached){
                                service.loadMorePosts("Lifestyle", getActivity(), new GetBlogCallback() {
                                    @Override
            ...
            service.loadFirstPosts("Lifestyle", getActivity(), new GetBlogCallback() {
                @Override
                public void onCallBack(BlogPost blogPost) {
                    if(blogPost !=null){
                        blogPostList.add(blogPost);
    ...
    public void initViews(View mView){
        ...
        recyclerView = mView.findViewById(R.id.lifestyle_recycler);
