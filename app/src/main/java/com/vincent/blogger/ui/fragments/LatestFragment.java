...
import com.vincent.blogger.ui.ExploreBlogActivity;
...
public class LatestFragment extends Fragment implements Redirect {
    ...
    LatestFragment(Activity activity){
    ...
    private void getBlogData() {
        ...
        if(recyclerView !=null){
            recyclerView.addOnScrollListener(
                    new RecyclerView.OnScrollListener() {
                        ...
                        public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                            ...
                            if(bottomReached){
                                service.loadMorePosts("latest", getActivity(), new GetBlogCallback() {
                                    @Override
            ...
            service.loadFirstPosts("latest", getActivity(), new GetBlogCallback() {
                @Override
                public void onCallBack(BlogPost blogPost) {
                    if(blogPost !=null){
                        blogPostList.add(blogPost);
    ...
    public void initViews(View mView){
        progressBar = mView.findViewById(R.id.home_prog_bar);
        blogPostList = new ArrayList<>();
        recyclerView = mView.findViewById(R.id.latest_recycler);
    ...
    public void redToExploreBlog(String desc, String coverImage, ArrayList<String> images, String date, String userId) {
        ...
        Intent intent = new Intent(mContext, ExploreBlogActivity.class);
        intent.putExtra(ExploreBlogActivity.DESCRIPTION, desc);
        intent.putExtra(ExploreBlogActivity.DATE, date);
        intent.putExtra(ExploreBlogActivity.COVER_IMAGE, coverImage);
        intent.putExtra(ExploreBlogActivity.IMAGES, images);
        intent.putExtra(ExploreBlogActivity.USER_ID, userId);
